const createClient = ()=>({});
const APP_CONFIG={QUESTIONS:[1],SUPABASE_URL:'x',SUPABASE_ANON_KEY:'y'};
const STICKERS=[{id:'a',emoji:'x',label:'x',colors:{bg:'#000',bgSoft:'#111',accent:'#222'}}];
const document={getElementById:()=>null,querySelector:()=>null,querySelectorAll:()=>[],body:{appendChild(){}}};
const window={location:{hash:'',origin:'',pathname:''},addEventListener(){},open(){}};
const localStorage={getItem(){return ''},setItem(){},removeItem(){}};
const navigator={clipboard:{writeText:async()=>{}}};
const FormData=function(){this.get=()=>''};
setTimeout(()=>{},0);
console={error(){},log(){}};
